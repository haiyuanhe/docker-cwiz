...
HBASE_HOME=<:install_root:>/hbase
HADOOP_HOME=<:install_root:>/hadoop
HBASE_CLASSPATH=$HADOOP_HOME/lib/hadoop-lzo-0.4.21-SNAPSHOT.jar
...
do
    ...
    do
        _hmaster_url="http://$_h:<:hbase_master_port:>/master-status?format=json"
