...
servers=("nginx" "opentsdb" "cloudwiz-user" "alertd" "kafka" "python-deamon" "cloudwiz-agent" "cmservice" "log-analysis" "log-pp" "log-processor" "metric-proxy" "permission" "webfront" "mysql" "hbase" "zookeeper")
