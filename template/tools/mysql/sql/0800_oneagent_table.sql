...
CREATE DATABASE `<:oneagent_database:>`;
...
CREATE TABLE `datasource_metric` (
  ...
  `is_pause` tinyint(4) DEFAULT '0' COMMENT '是否暂停',
...
-- ----------------------------
--  Table structure for `metric_transform`
-- ----------------------------
DROP TABLE IF EXISTS `metric_transform`;
CREATE TABLE `metric_transform` (
    `id` int(11) NOT NULL AUTO_INCREMENT,
    `metric_from` varchar(255) COLLATE utf8_bin DEFAULT NULL,
    `metric_to` varchar(255) COLLATE utf8_bin DEFAULT NULL,
    `tag_from` varchar(255) COLLATE utf8_bin DEFAULT NULL,
    `tag_to` varchar(255) COLLATE utf8_bin DEFAULT NULL,
    `is_deleted` tinyint(4) DEFAULT '0' COMMENT '是否已删除(0否，1删除）',
